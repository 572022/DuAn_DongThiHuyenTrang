...
namespace WebMULTI.Models
{
	...
	public partial class webMultiDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertProductimg(Productimg instance);
    partial void UpdateProductimg(Productimg instance);
    partial void DeleteProductimg(Productimg instance);
    #endregion
		
		public webMultiDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
        public webMultiDataContext() :
 base(global::System.Configuration.ConfigurationManager.ConnectionStrings["WebsiteQuanAoConnectionString"].ConnectionString, mappingSource)
        ...
        public webMultiDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public webMultiDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public webMultiDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Productimg> Productimgs
		{
			get
			{
				return this.GetTable<Productimg>();
			}
		}
	}
    ...
    partial void OnEcolorChanging(string value);
    partial void OnEcolorChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Ecolor", DbType="NVarChar(20) NOT NULL", CanBeNull=false)]
		public string Ecolor
		{
			...
			set
			{
				if ((this._Ecolor != value))
				{
					this.OnEcolorChanging(value);
					this.SendPropertyChanging();
					this._Ecolor = value;
					this.SendPropertyChanged("Ecolor");
					this.OnEcolorChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Color_Product_Color", Storage="_Product_Colors", ThisKey="idColor", OtherKey="idColor")]
    ...
    partial void OnidColorChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_pr", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int pr
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Color_Product_Color", Storage="_Color", ThisKey="idColor", OtherKey="idColor", IsForeignKey=true)]
		public Color Color
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_Product_Color", Storage="_SanPham", ThisKey="MaSP", OtherKey="MaSP", IsForeignKey=true)]
		public SanPham SanPham
		{
			get
			{
	...
	public partial class SanPham : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Productimg> _Productimgs;
    ...
    partial void OnSoLuongTonChanged();
		...
		public SanPham()
		{
			this._ChiTietDonHangs = new EntitySet<ChiTietDonHang>(new Action<ChiTietDonHang>(this.attach_ChiTietDonHangs), new Action<ChiTietDonHang>(this.detach_ChiTietDonHangs));
			this._Product_Colors = new EntitySet<Product_Color>(new Action<Product_Color>(this.attach_Product_Colors), new Action<Product_Color>(this.detach_Product_Colors));
			this._Productimgs = new EntitySet<Productimg>(new Action<Productimg>(this.attach_Productimgs), new Action<Productimg>(this.detach_Productimgs));
			this._DanhMuc = default(EntityRef<DanhMuc>);
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Mota", DbType="NVarChar(2000) NOT NULL", CanBeNull=false, IsDbGenerated=true, IsVersion=true)]
		public string Mota
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_Product_Color", Storage="_Product_Colors", ThisKey="MaSP", OtherKey="MaSP")]
		public EntitySet<Product_Color> Product_Colors
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_Productimg", Storage="_Productimgs", ThisKey="MaSP", OtherKey="MaSP")]
		public EntitySet<Productimg> Productimgs
		{
			get
			{
				return this._Productimgs;
			}
			set
			{
				this._Productimgs.Assign(value);
			}
		}
		...
		private void attach_Productimgs(Productimg entity)
		{
			this.SendPropertyChanging();
			entity.SanPham = this;
		}
		
		private void detach_Productimgs(Productimg entity)
		{
			this.SendPropertyChanging();
			entity.SanPham = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Productimg")]
	public partial class Productimg : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnpimgChanging(int value);
    ...
    partial void OnnameimgChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_pimg", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int pimg
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_nameimg", DbType="NVarChar(30)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_Productimg", Storage="_SanPham", ThisKey="MaSP", OtherKey="MaSP", IsForeignKey=true)]
		public SanPham SanPham
		{
			get
			{
			...
			set
			{
							...
							|| (this._SanPham.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._SanPham.Entity = null;
						previousValue.Productimgs.Remove(this);
					}
					this._SanPham.Entity = value;
					if ((value != null))
					{
						value.Productimgs.Add(this);
						this._MaSP = value.MaSP;
					}
					else
					{
